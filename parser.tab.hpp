...
/**
 ** \file parser.tab.hpp
 ** Define the SimpleCompiler::parser class.
 */
  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_NUMBER = 19,                           // NUMBER
        S_CHAR_LITERAL = 20,                     // CHAR_LITERAL
        S_21_ = 21,                              // '('
        S_22_ = 22,                              // ')'
        S_23_ = 23,                              // '{'
        S_24_ = 24,                              // '}'
        ...
        S_statement_list = 38,                   // statement_list
        S_statement = 39,                        // statement
        S_function_def = 40,                     // function_def
        S_param_list = 41,                       // param_list
        S_param = 42,                            // param
        S_declaration = 43,                      // declaration
        S_declaration_no_semi = 44,              // declaration_no_semi
        S_assignment = 45,                       // assignment
        S_if_stmt = 46,                          // if_stmt
        S_for_stmt = 47,                         // for_stmt
        S_for_init = 48,                         // for_init
        S_while_stmt = 49,                       // while_stmt
        S_return_stmt = 50,                      // return_stmt
        S_expression = 51,                       // expression
        S_assignment_expr = 52,                  // assignment_expr
        S_logical_or_expr = 53,                  // logical_or_expr
        S_logical_and_expr = 54,                 // logical_and_expr
        S_equality_expr = 55,                    // equality_expr
        S_relational_expr = 56,                  // relational_expr
        S_arithmetic_expr = 57,                  // arithmetic_expr
        S_term = 58,                             // term
        S_factor = 59,                           // factor
        S_function_call = 60,                    // function_call
        S_arg_list = 61,                         // arg_list
        S_type = 62                              // type
      };
    };
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::YYEOF
                   || (token::YYerror <= tok && tok <= token::OR)
                   || (40 <= tok && tok <= 41)
                   || tok == 123
                   || tok == 125
                   || tok == 59
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::IDENTIFIER <= tok && tok <= token::CHAR_LITERAL));
#endif
      }
    };
